...
cv_spacetimefolds <- CAST::CreateSpacetimeFolds(train_set,spacevar = "probe_name", k=5)#
...
#rf
plot(rfmodel$pred$obs[1:500000],rfmodel$pred$pred[1:500000],ylim=c(0,40),xlim=c(0,40),pch=20,col= rgb(red = 0, green = 0, blue = 1, alpha = 0.01))
abline(coef = c(0,1))
...
plot(test_set$soil_moisture,test_set$prediction,ylim=c(0,40),xlim=c(0,40))
abline(coef = c(0,1))
