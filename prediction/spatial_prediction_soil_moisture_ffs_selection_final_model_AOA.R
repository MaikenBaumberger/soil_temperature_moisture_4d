...
#hist(train_set_st$radolan_sum_18_24,breaks=100)
...
DIsm05 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm05.rds")
DIsm15 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm15.rds")
DIsm25 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm25.rds")
DIsm35 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm35.rds")
DIsm45 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm45.rds")
DIsm55 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm55.rds")
DIsm65 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm65.rds")
DIsm75 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm75.rds")
DIsm85 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIsm85.rds")
...
for (i in mid_month_2718){
  ...
  # plot(temp_spatially_72)
  # plot(temp_spatially_3_month)
  # plot(precipitation_spatially)
  # plot(radiation_spatially)
  # plot(radolan)
  # plot(radolan_sum_0_6)
  # plot(radolan_sum_12_18)
  # plot(radolan_sum_18_24)
  # plot(radolan_sum_0_24)
  # plot(prec_sum_3_month_spatially)
  # plot(texture_spatially)
  # plot(type_spatially)
  # plot(landuse_spatially)
  # plot(inclination_spatially)
  # plot(wettness_spatially)
  # plot(ndvi_spatially)
  ...
  #plot(AOA$AOA,col=c("white","transparent"),add=T,plg=list(x="topleft",box.col="black",bty="o",title="AOA"))
...
####################################################################################################################
  ...
  setwd("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_plots/final_model_hyper_AOA/soil_moisture_random_AOA_DI")
  
  writeRaster(pred_sm,paste0("pred_sm_",time,".tif"),overwrite=TRUE)
  
  writeRaster(pred_sm_AOA,paste0("pred_sm_AOA_",time,".tif"),overwrite=TRUE)
  
  writeRaster(AOA_mask_sm,paste0("AOA_mask_sm_",time,".tif"),overwrite=TRUE)
  
  writeRaster(DI_mask_sm,paste0("DI_mask_sm_",time,".tif"),overwrite=TRUE)
