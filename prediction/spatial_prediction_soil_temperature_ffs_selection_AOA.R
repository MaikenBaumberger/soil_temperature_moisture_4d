...
trainDI_05 <- readRDS("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/trainDI/depth5DI.rds")
trainDI_15 <- readRDS("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/trainDI/depth15DI.rds")
...
for (i in mid_month){
  ...
  AOA_05 <- aoa(predictors_05, trainDI = trainDI_05)
  ...
  AOA_15 <- aoa(predictors_15, trainDI = trainDI_15)
  ...
  #aoa_st = c(AOA_05,AOA_15)
  
  #names(aoa_st) = c(paste0(time,"_05_aoa"),
  #                   paste0(time,"_15_aoa"))
  
  
  
  setwd("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_plots/final_model_aoa/temperature_trainDI_test")
  writeRaster(pred_st,paste0("pred_st_",time,".tif"),overwrite=TRUE)
  saveRDS(AOA_05,paste0("aoa_st_",time,"_05.RData"))
  saveRDS(AOA_15,paste0("aoa_st_",time,"_15.RData"))
  
  
  
  prediction_05_aoa <- prediction_05
  aoa_05_mask = AOA_05$AOA==1
  prediction_05_aoa[!aoa_05_mask] <- NA
  
  prediction_15_aoa <- prediction_15
  aoa_15_mask = AOA_15$AOA==1
  prediction_15_aoa[!aoa_15_mask] <- NA
  
  plot(prediction_05)
  plot(prediction_05_aoa)
  plot(prediction_15_aoa)
