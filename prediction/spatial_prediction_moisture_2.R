...
load("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/predictor_set_complete_seasons_radolan_2.Rdata")
...
predictor_set_temperature_2 = cbind(predictor_set_temperature[1:2],predictor_set_temperature[60:61],predictor_set_temperature[13:59],predictor_set_temperature[4:12])
...
train_melt <- reshape2::melt(train_sub, id = c("probe_name","date_hour","id","air_temperature_mountain","air_temperature_valley","precipitation","global_radiation",
                                               ...
                                               "prec", "prec_sum_0_6","prec_sum_6_12","prec_sum_12_18","prec_sum_18_24","prec_sum_0_24","prec_sum_24_48","prec_sum_48_72",
