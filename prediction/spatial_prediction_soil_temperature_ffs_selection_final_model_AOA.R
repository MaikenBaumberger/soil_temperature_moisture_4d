...
DIst05 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst05.rds")
DIst15 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst15.rds")
DIst25 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst25.rds")
DIst35 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst35.rds")
DIst45 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst45.rds")
DIst55 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst55.rds")
DIst65 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst65.rds")
DIst75 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst75.rds")
DIst85 = readRDS("C:/Users/maike/Desktop/Carbon4D/Palma/AOA_TrainDI/trainDI_single_depths/DIst85.rds")
...
# set.seed(21)
# random_sample_1 = sample(x = 5137:13873, size  = 20)
# random_sample_1
...
#mid_month = c(6229,6901,7645,8365,9109,9829,10573,11317,12037,12781,13501)
...
for (i in mid_month_2718){
  ...
  #levels(predictors_05$land_use) <- data.frame(ID=c(1000,1500,1600,1700,1800,1900,2000,2100,2200), 
  #                                             land_use=c("1000","1500","1600","1700","1800","1900","2000","2100","2200"))
  #levels(predictors_05$soil_type) <- data.frame(ID=c(1,2,3,4,5), 
  #                                              soil_type=c("1","2","3","4","5"))
...
#############
  ...
  #setwd("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_plots/final_model_hyper_AOA/soil_temperature_12_AOA_DI")
  setwd("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_plots/final_model_hyper_AOA/soil_temperature_random_AOA_DI")
  
  writeRaster(pred_st,paste0("pred_st_",time,".tif"),overwrite=TRUE)
  
  writeRaster(pred_st_AOA,paste0("pred_st_AOA_",time,".tif"),overwrite=TRUE)
  
  writeRaster(AOA_mask_st,paste0("AOA_mask_st_",time,".tif"),overwrite=TRUE)
  
  writeRaster(DI_mask_st,paste0("DI_mask_st_",time,".tif"),overwrite=TRUE)
  ...
  # setwd("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_plots/final_model_hyper/soil_temperature_12_mit_AOA")
  # writeRaster(pred_st,paste0("pred_st_",time,".tif"),overwrite=TRUE)
  # 
