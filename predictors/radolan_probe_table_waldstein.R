...
probe_meta_data_longterm <- Carbon4D::load_probe_meta_data_longterm("C:/Users/maike/Desktop/Carbon4D/DownloadGitData")
probe_meta_data = rbind(probe_meta_data_longterm)
...
df <- as.data.frame(matrix(NA, 0, 24))#265
...
save(radolan_table, file = "radolan_table_waldstein.RData")
