...
load("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/soil_probes_data/list_probe_data_longterm.Rdata")

#list_probe_data_longterm.Rdata

Carbon4D::load_probe_meta_data_longterm("C:/Users/maike/Desktop/Carbon4D/DownloadGitData")
Carbon4D::load_longterm_probe_data("C:/Users/maike/Desktop/Carbon4D/DownloadGitData")

#list_probes = csv_list_longterm_probe_data
probe_meta_data = ProbeMetaDataLongterm
...
load("C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/radolan_data_study_area/radolan_table_sums_4_waldstein.RData")
...
probes_ndvi_t_2 = data.frame(do.call(rbind,lapply(lapply(split(probes_ndvi_t,probes_ndvi_t$datetime_ndvi_posix),`[`,2:18),colMeans,na.rm=T)))
...
#calculate mean of douple time stamps
probes_ndwi_t_2 = data.frame(do.call(rbind,lapply(lapply(split(probes_ndwi_t,probes_ndwi_t$datetime_ndwi_posix),`[`,2:18),colMeans,na.rm=T)))
...
#calculate mean of douple time stamps
probes_radar_t_2 = data.frame(do.call(rbind,lapply(lapply(split(probes_radar_t,probes_radar_t$datetime_radar_posix),`[`,2:18),colMeans,na.rm=T)))
...
plot(probes_radar_hourly$datetime,probes_radar_hourly$S12_014)
points(probes_radar_hourly_1$datetime,probes_radar_hourly_1$S12_014,col="red",pch=20)
...
save(predictor_set_2,file = "C:/Users/maike/Desktop/Carbon4D/GitHub_soil_temperature_moisture_4d_data/predictor_set_complete_seasons_radolan_4_Waldstein.Rdata")
